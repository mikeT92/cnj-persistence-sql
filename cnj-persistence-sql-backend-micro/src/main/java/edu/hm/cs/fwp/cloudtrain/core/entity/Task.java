...
import edu.hm.cs.fwp.cloud.common.persistence.jpa.audit.AbstractAuditableEntity;
...
public class Task extends AbstractAuditableEntity {
    ...
    private static final String JPA_NAME_PREFIX = "edu.hm.cs.fwp.cloudtrain.core.entity.Task.";
